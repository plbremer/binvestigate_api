...
if __name__ == "__main__":
    ...
    #print(test)
    temp_incoming_json_dict={"additional_slider_min_fold_change": 5, "additional_toggleswitch": True, "aggregate_on_page_rangeslider": None, "aggregate_on_page_spinners": 1, "compounds": ["18"], "from_disease": ["No"], "from_organ": ["A18.024.937"], "from_species": ["161934"], "to_disease": ["No"], "to_organ": ["A12.207.152", "A12.207.152.693", "A12.207.152.846"], "to_species": ["15367", "147368", "204232"]}
    ...
    #my_generated_query=
    #send a post requrest to the ip address at base along with the url extension foldchangetable, send the
    #json as a payload
