...
class ComplicatedQuery():
    ...
    def assign_query_metadata(self):
        ...
        self.metadata_dict={
            ...
            'compounds':self.net_query['compounds']
        }

    def create_metadata_query_string(self):
        ...
        pprint(self.metadata_dict)
        
        # the "array of choices way"
        ...
        for temp_key in temp_string_dict.keys():
            ...
            temp_string_dict[temp_key]=self.metadata_dict[temp_key]
        ...
        temp_compounds=temp_string_dict['compounds']
                ...
                (
                    ...
                    (
                        (
                            ...
                            cross join
                            unnest(array{temp_compounds} ) as comp
...
if __name__ == "__main__":
    ...
    my_ComplicatedQuery.assign_query_metadata()
    my_ComplicatedQuery.create_metadata_query_string()
